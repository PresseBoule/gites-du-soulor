  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Gîte 2 personnes à 30 min de Lourdes, dans les Pyrénées. Hébergement calme à Arrens-Marsous avec bain nordique et sauna. Alternative nature à Lourdes." />
            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="p-8 rounded-2xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 mb-8">
                  ...
                  <p className="text-white/90 leading-relaxed mb-6">
                    Les Gîtes du Soulor proposent <strong className="text-[#c4a574]">4 hébergements indépendants pour 2 personnes</strong>, idéaux pour un séjour en couple près de Lourdes. Chaque gîte est entièrement équipé et offre tout le confort moderne.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl bg-gradient-to-br from-[#c4a574]/10 to-transparent border border-[#c4a574]/20">
                      ...
                      <p className="text-white/70 text-sm">Gîte 2 personnes avec accès bien-être</p>
                    </div>
                    <div className="p-4 rounded-xl bg-gradient-to-br from-[#c4a574]/10 to-transparent border border-[#c4a574]/20">
                ...
                <div className="text-center mt-12">
                  ...
                  <p className="text-white/60 text-sm mt-4">
                    À 30 min de Lourdes • 4 gîtes 2 personnes • Bain nordique & sauna inclus
                  </p>
                </div>
              </motion.div>
            </div>
